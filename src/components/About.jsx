    ...
    <section id='about' className='bg-[#fafafa] py-[6rem] max-sm:py-10'>
        <div className='max-w-[120rem] w-[92%] m-auto'>
            <div className='text-center mb-[4rem]'>
                ...
                <p className='text-center text-[20px] text-[#555555] max-w-[80rem] w-[80%] m-auto max-sm:text-[17px] max-sm:w-full'>Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology</p>
            </div>
            <div className='flex max-w-[100rem] gap-10 max-sm:flex-col'>
                <div className='w-[50%] px-[10px] max-sm:w-full'>
                    <h3 className='text-[25px] font-bold tracking-[1px] pb-[2rem] max-sm:text-[22px]'>
                        Get to know me!
                    </h3>
                    <div className='text-[18px] text-[#555555] max-sm:text-[15px]'>
                        <p>
                        ...
                        <div className='flex py-[40px] space-x-10 items-center'>
                            <a href="./#contact" className='text-[15px] max-sm:text-[10px] text-[#fff] bg-[#7843e9] uppercase font-bold py-[15px] px-[60px] max-sm:px-8 max-sm:py-3 rounded tracking-[1px] shadow-[0_5px_15px_0_rgba(0, 0, 0, .15)] hover:translate-y-[-3px] duration-300'>
                            Contact
                            </a>
                            <a href="./#contact" className='text-[15px] max-sm:text-[10px] text-[#fff] bg-[#7843e9] uppercase font-bold py-[15px] px-[60px] max-sm:px-8 max-sm:py-3 rounded tracking-[1px] shadow-[0_5px_15px_0_rgba(0, 0, 0, .15)] hover:translate-y-[-3px] duration-300'>
                            Resume
                    ...
                    <div className='flex flex-wrap gap-3'>
                        {
                            skills.map(
                                (s,index) => {
                                    return(<div key={index} className='text-[15px] max-sm:text-[12px] bg-[#99999933] rounded text-[#555555] font-semibold px-[2rem] py-[.8rem] max-sm:px-5 max-sm:py-3 mr-0.5 mb-0.5'>{s.skill}</div>)
                                }
                            )
                        }
                    </div>
